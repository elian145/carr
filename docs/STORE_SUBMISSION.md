...
- Account deletion (store forms): **Profile → Delete account**, confirmed with an **SMS code** to the account phone. Web path (Play requirement): `https://carr-5hrm.onrender.com/delete-account` (or `{API_BASE}/delete-account`).
