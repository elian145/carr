...
void main() {
  ...
  testWidgets('Legacy dealer profile loads mock dealer profile', (tester) async {
    ...
    nav.pushNamed(
      '/dealer/profile',
      arguments: {'dealerPublicId': 'dealer_test_1'},
    );
    await tester.pump();
    ...
    for (var i = 0; i < 80; i++) {
      ...
      if (find.text('Test Dealer').evaluate().isNotEmpty) {
        ready = true;
        break;
      }
    }
