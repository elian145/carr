...
void main() {
  ...
  testWidgets(
    'Legacy car detail renders listing from mock API without cache',
    (tester) async {
      const carId = 'detail_net_1';
      SharedPreferences.setMockInitialValues({'push_enabled': false});
      ...
      expect(rendered, isTrue, reason: 'Car detail should load from mock GET /cars/:id');
      expect(find.text('Car not found'), findsNothing);
    },
    timeout: const Timeout(Duration(seconds: 30)),
  );
