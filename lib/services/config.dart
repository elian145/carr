...
// Base like: http://10.0.2.2:5003 (NO trailing slash)
// Use 10.0.2.2 for Android emulator (maps to host's localhost:5003)
const String kApiBase = String.fromEnvironment('API_BASE', defaultValue: 'http://10.0.2.2:5003');
