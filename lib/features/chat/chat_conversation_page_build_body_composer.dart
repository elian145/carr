...
mixin _ChatConversationPageBuildBodyComposer
    on _ChatConversationPageBuildBodyMessages {
  List<Widget> _buildChatComposerSection(BuildContext context) {
    final compact = AppResponsive.isCompactPhone(context);
    final mediaDisabled =
        _isSending || _editingMessageId != null || _isRecordingVoice;
    final voiceDisabled = _isSending || _editingMessageId != null;
    Widget attachmentButton() => IconButton(
      onPressed: mediaDisabled ? null : _pickAndSendMultipleMedia,
    ...
    Widget cameraButton() => IconButton(
      onPressed: mediaDisabled ? null : _takePhotoAndSend,
    ...
    Widget voiceButton() => IconButton(
      onPressed: voiceDisabled ? null : _toggleVoiceRecording,
      icon: Icon(
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_isRecordingVoice) _buildVoiceRecordingBanner(context),
            if (_editingMessageId != null && _editingKeepAttachments.isNotEmpty)
            ...
            if (compact)
              Align(
                ...
                child: Wrap(
                  spacing: 4,
                  children: [attachmentButton(), cameraButton(), voiceButton()],
                ),
              ),
            Row(
              children: [
