...
class _ChatConversationPageState extends _ChatConversationFields
    with _ChatConversationTransportStore, _ChatConversationTransport, _ChatConversationMedia, _ChatConversationMessageActions, _ChatConversationComposer, _ChatConversationMessageUiNav, _ChatConversationMessageUi, WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
