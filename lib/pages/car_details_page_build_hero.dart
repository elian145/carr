...
mixin _CarDetailsPageBuildHero on _CarDetailsPageContact {
  ...
  double _carDetailsTitleContentHeight(BuildContext context) {
    ...
    height += _metaBlockHeight(context);
  ...
  static const double _specsTitleTopGap = 4;
  static const double _specsTitleBottomGap = 10;
  ...
  double _metaBlockHeight(BuildContext context) {
    final cityDetail = (listingFirstNonEmpty(car!, ['city', 'location']) ?? '')
        .trim();
  ...
  double _specsTitleBlockHeight(BuildContext context) {
    ...
    // Small buffer for bold ascenders that can exceed TextPainter on some fonts.
  ...
  Widget _buildCarDetailsTitleHeader(BuildContext context, bool isLightShell) {
    ...
    return Material(
      ...
      child: Theme(
        ...
        child: Padding(
          padding: const EdgeInsets.fromLTRB(16, 12, 16, _specsTitleBottomGap),
          child: Column(
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (ctx) => [
              PopupMenuItem(
                ...
                child: Text(AppLocalizations.of(ctx)!.reportListing),
              ),
              if ((sellerMapFromListing(car)?['id'] ??
                ...
                PopupMenuItem(
                  value: 'report_user',
                  child: Text(AppLocalizations.of(ctx)!.reportSeller),
                ),
            ],
          ),
      ],
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                final idx = _currentImageIndex.clamp(0, _heroMediaCount - 1);
              ...
              child: IgnorePointer(
                ...
                child: Center(
                  child: () {
                    ...
                    final int visible = total < kMaxVisible
                        ? total
                        : kMaxVisible;
                    if (visible <= 1) {
                      return const SizedBox.shrink();
                    ...
                    final int start = computeDotStart(_currentImageIndex);
