...
export '../shared/listings/global_listing_card.dart'
    show
        buildGlobalCarCard,
        mapListingToGlobalCarCardData,
        listingCardTitleNoYear,
        listingCardTrimLine,
        listingUploadedAgo;
...
part 'saved_searches_legacy.dart';
...
String _localizedCarTitleForCard(BuildContext context, Map car) =>
    listingCardTitleNoYear(context, Map<String, dynamic>.from(car));
...
String _localizedTrimForCard(BuildContext context, Map car) =>
    listingCardTrimLine(context, Map<String, dynamic>.from(car));

String _listingUploadedAgo(BuildContext context, Map car) =>
    listingUploadedAgo(context, Map<String, dynamic>.from(car));
